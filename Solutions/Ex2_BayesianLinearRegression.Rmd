...
$$
a_n= a_0+\frac{p}{2}, \quad b_n = b_0 + \frac{\mathbb{E}[\boldsymbol\beta^{T}\boldsymbol \beta]}{2}.
$$
...
$$
\mathbb{E}[\kappa] = \frac{a_n}{b_n}, \quad \mathbb{E}[\boldsymbol\beta^{T}\boldsymbol \beta] = \boldsymbol m_n^{T} \boldsymbol m_n+ \text{tr}(\boldsymbol S_n).
$$